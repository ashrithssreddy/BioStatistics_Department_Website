0. To update the content to be dispayed on the website, just upload the images in the folder and change the content of students_details.csv file.
1. Avoid commas(,) in the spreadsheet since its a .CSV file (comma seprated values)
2. Store the images of students in this folder only and mention the filename of the image in excel file (students_details.csv)
3. Every entry in students_details.csv will be displayed on the website. 
